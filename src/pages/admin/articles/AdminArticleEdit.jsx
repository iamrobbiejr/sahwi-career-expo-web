...
import {ChevronLeft, Send, Tag, Loader2} from 'lucide-react';
...
const AdminArticleEdit = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await articlesService.update(id, submitData);
        ...
        return (
            <div className="max-w-4xl mx-auto py-12 text-center">
                ...
                <button onClick={() => navigate('/admin/articles')}
                        className="mt-4 text-primary-600 hover:underline flex items-center justify-center gap-2 mx-auto">
        ...
        <div className="max-w-4xl mx-auto space-y-6 pb-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex justify-end gap-4">
                    ...
                    >
                        {isUpdating ? <span className="animate-spin mr-2">◌</span> : <Send className="w-4 h-4"/>}
                        Update Article
                    </button>
                </div>
            </form>
