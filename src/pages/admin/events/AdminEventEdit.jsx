...
const AdminEventEdit = () => {
        ...
        const fetchEvent = async () => {
            try {
                ...
                const formatDeadlineDate = (dateString) => {
                    if (!dateString) return '';
                    return dateString.split('T')[0]; // "2026-01-28"
                };
                ...
                setFormData({
                    ...
                    price: event.price_cents ? event.price_cents / 100 : event.price || 0,
                    banner: event.img || event.banner || '',
                    image: null,
                    registration_deadline: formatDeadlineDate(event.registration_deadline),
                    currency: event.currency || 'USD',
                });

                // Try to infer location type
                if (event.venue && (event.venue.toLowerCase() === 'virtual' || event.venue.toLowerCase() === 'online')) {
                    setLocationType('virtual');
                } else {
                    setLocationType('in-person');
                }

                if (event.img || event.banner) {
                    setImagePreview(formatImageUrl(event.img || event.banner));
                }

                // Fetch panels and activities if they are not already in the event object
                if (event.panels) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const submitData = {
                ...formData,
                venue: locationType === 'virtual' ? 'Virtual' : formData.venue,
                img: bannerUrl,
                banner: bannerUrl,
                panels,
                activities
            ...
            if (submitData.is_paid && submitData.price) {
                submitData.price_cents = Math.round(parseFloat(submitData.price) * 100);
                delete submitData.price;
            }

            await eventsService.adminUpdate(id, submitData);
        ...
        <div className="max-w-4xl mx-auto space-y-6">
            <div className="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p className="text-gray-600">Update the details of the event.</p>
                </div>
            </div>
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-6">
                        <div className="flex items-start gap-3 mb-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-600">Upload an attractive image to represent your
                                    event</p>
                            </div>
                        </div>
                                ...
                                <div className="relative">
                                    ...
                                    <button
                                        ...
                                        onClick={() => {
                                            ...
                                            setFormData(prev => ({...prev, image: null, banner: ''}));
                                        }}
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                        ...
                        <div className="space-y-4">
                            ...
                            {locationType === 'virtual' && (
                                <div
                                    className="p-4 bg-cyan-50 rounded-lg border border-cyan-200 flex items-start gap-3">
                            ...
                            {formData.is_paid ? (
                                ...
                                <div
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-green-700">This event is free to attend. No
                                            registration fee will be charged.</p>
                                    </div>
                                </div>
                            )}
                        </div>
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                        ...
                        <div>
                            ...
                            <div className="mt-2 p-3 bg-blue-50 rounded-lg flex items-start gap-2">
                                ...
                                <p className="text-sm text-blue-800">Students must register before this date to attend
                                    the event</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 space-y-4">
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2">
                                ...
                                <h2 className="text-lg font-bold text-gray-900">Event Panels</h2>
                            </div>
                            <button
                                type="button"
                                onClick={addPanel}
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 space-y-4">
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2">
                                ...
                                <h2 className="text-lg font-bold text-gray-900">Event Activities</h2>
                            </div>
                            <button
                                type="button"
                                onClick={addActivity}
                                ...
                                <div key={index} className="p-4 bg-gray-50 rounded-lg border border-gray-200 relative">
                                    ...
                                    <div className="space-y-4">
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            ...
                                            <div>
                                                <label
                                                    className="block text-sm font-medium text-gray-700 mb-1">Type</label>
                                                <select
                                                    value={activity.type}
